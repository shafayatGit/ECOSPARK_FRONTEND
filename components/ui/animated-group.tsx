...
type AnimationVariant = {
  ...
  [key: string]: TargetAndTransition | undefined;
};
...
const defaultContainerVariants: AnimationVariant = {
  hidden: { opacity: 0 },
  visible: {
    opacity: 1,
    transition: {
...
const defaultItemVariants: AnimationVariant = {
  hidden: { opacity: 0 },
  visible: { opacity: 1 },
};
...
const presetVariants: Record<
  PresetType,
  { container: AnimationVariant; item: AnimationVariant }
> = {
  fade: {
